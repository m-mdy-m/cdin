...
function core.init()
  ...
  -- layout, top to bottom: title bar (locked) / editor content / command
  -- line (locked) / status bar (locked). See titlebar.lua for why this
  -- needs to exist at all: the window itself has no OS decorations.
