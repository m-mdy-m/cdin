...
-- Height of the custom title bar drawn by core.titlebar (see
-- data/core/titlebar.lua). Kept slim, VSCode-style, not the fat caption
-- bar the OS would otherwise give us.
...
-- ── VEX-inspired palette ──
-- Near-black, low-saturation, a single soft purple accent. Same family
-- of colors as the VEX vim config: easy on the eyes, nothing neon,
-- nothing that screams for attention except the things that should.
...
-- subtle, monochrome-leaning syntax palette with the purple accent
-- reserved for keywords/keywords2, matching VEX's "Keyword" highlight.
style.syntax = {}
